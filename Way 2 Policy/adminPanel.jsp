...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<form>
				<div class="container" style="padding-top:200px; margin-left: 300px;">
					<div class="row">
						<div class="col-md-3"> <button class="button" name="addpolicy" value="add_policy" style="border-radius: 8.5rem"><img src="images/add.jfif" height="320px"
									width="320px" style="border-radius: 8.5rem"></button></div>
						<div class="col-md-3"></div>
						<div class="col-md-3"> <button class="button" name="editpolicy" value="edit_policy" style="border-radius: 8.5rem"><img src="images/edit.png" height="320px"
									width="320px" style="border-radius: 8.5rem"></button></div>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<p><span style="color:rgb(255, 115, 0);font-weight:bold;text-align:center;margin-left:110px;font-size: 25px;">Add
									Policy</span></p>
						</div>
						<div class="col-md-3"></div>
						<div class="col-md-3">
							<p><span style="color:rgb(255, 115, 0);font-weight:bold;text-align:center;margin-left:120px;font-size: 23px;">Edit
									Policy</span></p>
						</div>
					</div>
				</div>
